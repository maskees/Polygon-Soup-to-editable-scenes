...
def main(input, output, stages, backend, up_axis, low_vram, config, skip_existing):
    ...
    with Progress() as progress:
        ...
        for idx in stage_list:
            ...
            try:
                ...
                console.print(f"[green]  ✓ Stage {idx} complete[/]")
            except Exception as e:
                console.print(f"[bold red]  ✗ Stage {idx} failed: {e}[/]")
                raise
